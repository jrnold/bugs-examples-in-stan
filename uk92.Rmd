...
These data come from @KatzKing1999a, were re-analyzed @TomzTuckerWittenberg2002.[^uk92-source] 
...
- Given this model replicate some of the results in @KatzKing199a.
...
- @TomzTuckerWittenberg2002 suggest using seemingly unrelated regressions (SUR). Model the data with SUR. How does it compare in results and speed?
