...
This model is similar to, and a simplied form of the polling aggregation methods recently and most notably used by FiveThirtyEight, HuffingtonPost, DailyKos, NYTimes Upshot and others in US elections [@Linzer2013a].
