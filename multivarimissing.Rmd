...
\gamma_1 &\sim \mathsf{Normal}(0, 10) \\
\gamma_2 &\sim \mathsf{Normal}(0, 2.5) \\
\sigma_x &\sim \mathsf{HalfCauchy}(0, 5) \\
y_i &\sim \mathsf{Normal}(\mu_{y,i}, \sigma_y) \\
\mu_{y,i} &= \beta_1 + \beta_2 y_i + \beta_3 z_i \\
\beta_1 &\sim \mathsf{Normal}(0, 10) \\
\beta_2, \beta_3 &\sim \mathsf{Normal}(0, 2.5) \\
\sigma_y &\sim \mathsf{HalfCauchy}(0, 5) \\
